...
--------------------------------------------------------------------------------
Version: 	1.0
Author:		Michael W鰄rer, http://www.sw-guide.de
 ...
 ******************************************************************************/
	...
	qtButtons.push(
		new qtButton('qt_bold', 'Strong', '<strong>' ,'</strong>' ,'Fettschrift', 'b')
	);
	qtButtons.push(
		new qtButton('qt_italic', 'Italic', '<em>', '</em>' ,'Kursivschrift', 'k')
	);
	qtButtons.push(
		new qtButton('qt_block', 'Indent', '<blockquote>', '</blockquote>' ,'Zitieren', 'z')
	);
	qtButtons.push(
